...
/*!
	  ...
	  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
	  */
!function(e,t){e.exports=function(e,t,n,i){const s=e=>e&&"object"==typeof e&&"default"in e?e:{default:e},o=s(t),r=s(n),a="toast",l=".bs.toast",c=`mouseover${l}`,u=`mouseout${l}`,d=`focusin${l}`,f=`focusout${l}`,h=`hide${l}`,p=`hidden${l}`,g=`show${l}`,m=`shown${l}`,_="fade",b="hide",v="show",y="showing",w={animation:"boolean",autohide:"boolean",delay:"number"},x={animation:!0,autohide:!0,delay:5e3};class E extends r.default{constructor(e,t){super(e,t),this._timeout=null,this._hasMouseInteraction=!1,this._hasKeyboardInteraction=!1,this._setListeners()}static get Default(){return x}static get DefaultType(){return w}static get NAME(){return a}show(){if(o.default.trigger(this._element,g).defaultPrevented)return;this._clearTimeout(),this._config.animation&&this._element.classList.add(_);const t=()=>{this._element.classList.remove(y),o.default.trigger(this._element,m),this._maybeScheduleHide()};this._element.classList.remove(b),e.reflow(this._element),this._element.classList.add(v,y),this._queueCallback(t,this._element,this._config.animation)}hide(){if(!this.isShown())return;if(o.default.trigger(this._element,h).defaultPrevented)return;const e=()=>{this._element.classList.add(b),this._element.classList.remove(y,v),o.default.trigger(this._element,p)};this._element.classList.add(y),this._queueCallback(e,this._element,this._config.animation)}dispose(){this._clearTimeout(),this.isShown()&&this._element.classList.remove(v),super.dispose()}isShown(){return this._element.classList.contains(v)}_maybeScheduleHide(){this._config.autohide&&(this._hasMouseInteraction||this._hasKeyboardInteraction||(this._timeout=setTimeout((()=>{this.hide()}),this._config.delay)))}_onInteraction(e,t){switch(e.type){case"mouseover":case"mouseout":this._hasMouseInteraction=t;break;case"focusin":case"focusout":this._hasKeyboardInteraction=t}if(t)return void this._clearTimeout();const n=e.relatedTarget;this._element===n||this._element.contains(n)||this._maybeScheduleHide()}_setListeners(){o.default.on(this._element,c,(e=>this._onInteraction(e,!0))),o.default.on(this._element,u,(e=>this._onInteraction(e,!1))),o.default.on(this._element,d,(e=>this._onInteraction(e,!0))),o.default.on(this._element,f,(e=>this._onInteraction(e,!1)))}_clearTimeout(){clearTimeout(this._timeout),this._timeout=null}static jQueryInterface(e){return this.each((function(){const t=E.getOrCreateInstance(this,e);if("string"==typeof e){if(void 0===t[e])throw new TypeError(`No method named "${e}"`);t[e](this)}}))}}return i.enableDismissTrigger(E),e.defineJQueryPlugin(E),E}(r(),c(),w(),A())}(Qt);var Kt,Xt,Yt,Jt=Qt.exports;Kt=navigator.userAgent.toLowerCase().indexOf("webkit")>-1,Xt=navigator.userAgent.toLowerCase().indexOf("opera")>-1,Yt=navigator.userAgent.toLowerCase().indexOf("msie")>-1,(Kt||Xt||Yt)&&document.getElementById&&window.addEventListener&&window.addEventListener("hashchange",(function(){var e,t=location.hash.substring(1);/^[A-z0-9_-]+$/.test(t)&&(e=document.getElementById(t))&&(/^(?:a|select|input|button|textarea)$/i.test(e.tagName)||(e.tabIndex=-1),e.focus())}),!1);document.addEventListener("DOMContentLoaded",(function(){(()=>{const e=document.getElementById("acf-form");if(!e)return;e.addEventListener("submit",(function(t){t.preventDefault(),e.querySelectorAll(".acf-error-message").forEach((e=>{e.remove()}));const n=new FormData(e),i=new XMLHttpRequest;i.open("POST","/wp-json/api/save_realty",!0),i.onload=function(){if(i.status>=200&&i.status<400){console.log("Form submitted successfully");const t=JSON.parse(i.responseText),n=document.querySelector("#carouselRealty .carousel-inner");n&&"success"===t.message&&(n.insertAdjacentHTML("afterbegin",t.post),e.reset(),e.querySelector(".acf-gallery-attachments").innerHTML="",jQuery("#successModal").modal("show"))}else console.error("Form submit error"),console.error(i.statusText)},i.onerror=function(){console.error("Form submit error")},i.send(n)})),document.getElementById("successModal").addEventListener("hidden.bs.modal",(function(){window.scrollTo({top:0,behavior:"smooth"})}))})(),(()=>{function e(e){return function(t){if(t.matches){const t=document.querySelector(".several-elements .carousel-inner");if(!t)return;const n=t.querySelector(".carousel-item").offsetWidth;let i=0;document.querySelector(".carousel-control-next").addEventListener("click",(()=>{const s=t.scrollWidth;i<s-n*e&&(i+=n,t.scrollTo({left:i,behavior:"smooth"}))})),document.querySelector(".carousel-control-prev").addEventListener("click",(()=>{i>0&&(i-=n,t.scrollTo({left:i,behavior:"smooth"}))}))}}}const t=window.matchMedia("(min-width: 1400px)"),n=window.matchMedia("(min-width: 992px)"),i=window.matchMedia("(min-width: 768px)");t.addEventListener("change",e(4)),n.addEventListener("change",e(3)),i.addEventListener("change",e(2)),e(4)(t),e(3)(n),e(2)(i)})()})),e.Alert=T,e.Button=k,e.Carousel=I,e.Collapse=M,e.Dropdown=vt,e.Modal=Lt,e.Offcanvas=jt,e.Popover=Bt,e.Scrollspy=qt,e.Tab=Vt,e.Toast=Jt,e.Tooltip=Rt}));
